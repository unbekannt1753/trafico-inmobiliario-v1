              ...
              <div className="type-grid">
                {[
                  ...
                  <div key={k} className={"type-card" + (type === k ? " active" : "")} onClick={() => setType(k)}>
                    <div className="ic" style={{color:type===k?"var(--orange)":"var(--ink)"}}><Icon name={ic} size={28}/></div>
          ...
          {step === 6 && (
            <>
              <div style={{textAlign:"center", padding:"40px 0"}}>
                ...
                <button className="btn btn-primary btn-lg" style={{marginTop:32}} onClick={() => goto("home")}>
