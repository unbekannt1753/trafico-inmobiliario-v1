const Search = ({ goto, favs, toggleFav, params }) => {
  const [op, setOp] = useState(params?.op || "venta");
  const [types, setTypes] = useState(new Set());
  const [cities, setCities] = useState(new Set(params?.city ? [params.city] : []));
