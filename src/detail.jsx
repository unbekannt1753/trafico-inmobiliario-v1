const Detail = ({ goto, favs, toggleFav, params }) => {
    ...
    <div className="page-fade">
      <div className="container" style={{paddingTop:20}}>
        ...
        <div style={{display:"flex", alignItems:"center", gap:8, fontSize:13, color:"var(--ink-soft)", marginBottom:12}}>
          <span style={{cursor:"pointer"}} onClick={() => goto("home")}>Inicio</span>
          <Icon name="chevron-right" size={12}/>
          <span style={{cursor:"pointer"}} onClick={() => goto("search")}>{p.operation === "venta" ? "Comprar" : "Rentar"}</span>
          <Icon name="chevron-right" size={12}/>
          <span style={{cursor:"pointer"}}>{p.city}</span>
          <Icon name="chevron-right" size={12}/>
          ...
          <div>
            ...
            <section style={{marginBottom:48}}>
              ...
              <div className="amenities">
                {p.amenities.map(a => {
                  const icMap = { "Roof garden": "home", "Gimnasio": "dumbbell", "Alberca": "pool", "Pet friendly": "paw", "Seguridad 24/7": "shield", "Amueblado": "home", "Internet": "wifi", "Internet 300mb": "wifi", "Calentador solar": "sun" };
                  return (
            ...
            <section style={{marginBottom:48}}>
              ...
              <div style={{display:"grid", gridTemplateColumns:"repeat(4, 1fr)", gap:16, marginTop:20}}>
                {[["Supermercado", "180 m"], ["Metro/Transporte", "6 min"], ["Escuelas", "4 cerca"], ["Parques", "2 a pie"]].map(([k, v]) => (
