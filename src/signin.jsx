const SignIn = ({ goto }) => {
  ...
  const [userType, setUserType] = useState("comprador"); // comprador | agente | propietario
      ...
      <div className="signin-wrap">
        ...
        <main className="signin-main">
          <div className="signin-topbar">
            ...
            <button className="btn-link-sm" onClick={() => goto("home")}>← Volver al inicio</button>
          </div>
          ...
          <div className="signin-form-wrap">
            ...
            <form onSubmit={submit} className="signin-form">
                  ...
                  <div className="user-type">
                    {[
                      ...
                      <label key={t.id} className={"ut-card" + (userType === t.id ? " active" : "")}>
                        <input type="radio" name="ut" checked={userType === t.id} onChange={() => setUserType(t.id)}/>
                        <div>
              ...
              <div className="signin-alt">
                {mode === "login" ? (
                  <>¿Primera vez? <a onClick={() => setMode("register")}>Crea tu cuenta</a></>
                ) : (
                  <>¿Ya tienes cuenta? <a onClick={() => setMode("login")}>Ingresa</a></>
                )}
              </div>
            </form>
